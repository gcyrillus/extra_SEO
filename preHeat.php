<?php	
	$homeCloneModes=preg_replace('/\s+/', '', $homeCloneModes = $this->plxPlugins->aPlugins[basename(__DIR__)]->getParam('cloneMode')=='' ? '0' : $this->plxPlugins->aPlugins[basename(__DIR__)]->getParam('cloneMode'));
